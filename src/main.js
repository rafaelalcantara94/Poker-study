...
function loginView(){
  app.innerHTML = `<main class="auth"><div class="authbox"><div class="brand">Poker <b>Study</b><small>V14.3.0 • CORRECTION COMMAND CENTER</small></div>
...
function shell(){
  app.innerHTML=`<div class="app"><aside class="sidebar"><div class="brand">Poker <b>Study</b><small>V14.3.0 • CORRECTION COMMAND CENTER</small></div><nav class="nav">
...
async function publishTeamSnapshot(facts){
  ...
  try{
    ...
    console.info('[Poker Study][RoomDiag] publish input',{localCounts,roomsAvailable:payload.roomsAvailable,roomBreakdown:payload.roomBreakdown,pokerIdentities:payload.pokerIdentities})
    ...
    console.info('[Poker Study][RoomDiag] server readback',serverDiag)
