...
function loginView(){
  app.innerHTML = `<main class="auth"><div class="authbox"><div class="brand">Poker <b>Study</b><small>V10.1.17 • TEAM READY</small></div>
...
function shell(){
  app.innerHTML=`<div class="app"><aside class="sidebar"><div class="brand">Poker <b>Study</b><small>V10.1.17 • TEAM READY</small></div><nav class="nav">
...
function withdrawalCashGate(playerId){
  ...
  const effectiveCash=Math.max(0,snapshot-withdrawalsAfter),max=Math.max(0,effectiveCash-active)
