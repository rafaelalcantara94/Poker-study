...
## Banco de dados
Nenhum SQL novo é necessário. A V9.5 cria metas automáticas dos leaks a partir das revisões já salvas e do snapshot local do Stats HH.
